...
# Change from 0 to 1 if default device isn't opening up
cap = cv2.VideoCapture(0)

# Read the first frame as baseline
ret, prev_frame = cap.read()

# SAFETY CHECK: If the first frame is empty, try waiting a split second or loop until it reads successfully
